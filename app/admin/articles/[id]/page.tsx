...
import { FaSave, FaTimes, FaArrowLeft, FaToggleOn, FaToggleOff } from "react-icons/fa"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {published ? "Artikel akan terlihat oleh publik" : "Artikel disimpan sebagai draft"}
                  </p>
                </div>
                <button
                  type="button"
