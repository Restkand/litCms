...
INSERT INTO "new_Article" ("authorId", "content", "createdAt", "id", "published", "slug", "title", "updatedAt") SELECT "authorId", "content", "createdAt", "id", "published", "slug", "title", "updatedAt" FROM "Article";
DROP TABLE "Article";
